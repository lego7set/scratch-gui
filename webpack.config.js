    ...
    defaultsDeep({}, base, {
        ...
        plugins: base.plugins.concat([
            ...
            new HtmlWebpackPlugin({
                ...
                template: 'src/playground/index.ejs',
                filename: 'index.html',
                title: 'Flash Redux - A mod of PenguinMod',
                ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['fullscreen'],
            ...
            new HtmlWebpackPlugin({
                ...
                template: 'src/playground/index.ejs',
                filename: 'embed.html',
                title: 'Embedded Project - Flash Redux',
                noTheme: true,
                ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                ...
                title: 'Addon Settings - Flash Redux',
                ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['credits'],
                ...
                title: 'PenguinMod, Flash Redux & TurboWarp Credits',
                noSplash: true,
                ...htmlWebpackPluginCommon
            }),
