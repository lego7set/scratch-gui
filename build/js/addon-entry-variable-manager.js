...
/* harmony default export */ __webpack_exports__["default"] = (async function (_ref) {
  ...
  function fullReload() {
    ...
    if (((_addon$tab$redux$stat = addon.tab.redux.state) === null || _addon$tab$redux$stat === void 0 ? void 0 : (_addon$tab$redux$stat2 = _addon$tab$redux$stat.scratchGui) === null || _addon$tab$redux$stat2 === void 0 ? void 0 : (_addon$tab$redux$stat3 = _addon$tab$redux$stat2.editorTab) === null || _addon$tab$redux$stat3 === void 0 ? void 0 : _addon$tab$redux$stat3.activeTabIndex) !== variableManagerTabId || preventUpdate) return;
  ...
  varTab.addEventListener("click", e => {
    addon.tab.redux.dispatch({
      ...
      activeTabIndex: variableManagerTabId
    });
  });
