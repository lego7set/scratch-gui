...
const fetchProjectToken = projectId => {
    ...
    return fetch(`https://projects.mubi.tech/api/projects/getPublished?id=${projectId}`)
        .then(r => {
            if (!r.ok) return null;
            return r.json();
        })
        ...
        fetchProject(projectId, loadingState) {
            ...
            if (projectUrl) {
                ...
                if (projectId === '0') {
                    ...
                    projectUrl = `https://projects.mubi.tech/api/projects/getPublished?type=file&safe=true&id=${projectId}`
                    assetPromise = progressMonitor.fetchWithProgress(projectUrl)
                        .then(r => {
                            this.props.vm.runtime.renderer.setPrivateSkinAccess(false);
                            if (!r.ok) {
